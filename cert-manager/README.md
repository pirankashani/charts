...
```console
# Kubernetes 1.15+
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.0.0/cert-manager.crds.yaml

# Kubernetes <1.15
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.0.0/cert-manager-legacy.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.0.0` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.0.0` |
