...
$ helm install my-release --namespace cert-manager --version v1.5.1 jetstack/cert-manager
```
...
| `webhook.image.tag` | Webhook image tag | `v1.5.1` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.5.1` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.5.1` |
