...
```console
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.4.3/cert-manager.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.4.3` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.4.3` |
